...
public class assignment4optionalArreglo {
                    ...
                    if (price==0) {
                        ...
                        if (numTickets<=num_Seats) {
                            ...
                            //Automatic selection the same as manual, but it is randomized and no message is shown.
                                ...
                                for (int i = 1; i <=numTickets; i++) {
                                    do {
                                        seat_position=(int) (Math.random()*20);
                                    } while(seats[seat_position] == 'O');
                                    seats[seat_position]='O';
                                    System.out.println("The seat " + seat_position + 1 + " has been asigned to passenger " + i);
                                }
                            }
