                ...
                switch (option) {
                    ...
                    do {
                        ...
                        if (numTicketsminor>=numTickets) {
                            System.out.println("ERROR! Minors should be accompanied by an adult. Try again ");
                        }
                                ...
                                System.out.println("\n");
                                    ...
                                    for (int i=1;i<=numTickets;i++) {
                                        do {
                                            ...
                                            if (seats[positionRow][positionColumn]=='O') {
                                                System.out.println("Sorry. This seat is already occupied. Select again");
                                            }

                                            if ((positionRow-1)>rows || (positionRow-1)<0) {
                                                System.out.println("Sorry. The row position is out of range. Try again.");
                                            }

                                            if ((positionColumn-1)>rows || (positionColumn-1)<0) {
                                                System.out.println("Sorry. The column position is out of range. Try again.");
                                            }

                                        } while (seats[positionRow][positionColumn]=='O' || (positionRow-1)>rows || (positionRow-1)<0 || (positionColumn-1)>rows || (positionColumn-1)<0 );
                                    ...
                                    for (int i=0;i<seats.length; i++) {
                                        for (int j=0;j<seats[0].length; j++) {
                                            ...
                                            if (numTickets==cont) {
                                                ...
                                                j=seats[0].length; //Breaking both loops
                                                i=seats.length;
                                            }
