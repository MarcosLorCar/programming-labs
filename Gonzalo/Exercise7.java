...
public class Exercise7 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do{
            ...
            int availableSeats=AvailableSeats(seats);
    ...
    public static char[][] CurrentStatus(char seats[][]){
    ...
    public static char[][] AllSeatsA(char seats[][]){
        for(int i = 0;i < ROWS; i++){
            for(int j = 0; j < COLUMNS; j++){
                seats[i][j] = AVAILABLE;
            }
    ...
    public static int ReadNumber(int LB, int UB){
    ...
    public static void MainMenu(char seats[][],double price){
        // Show the main menu
                            ...
                            case 1: 
                                ...
                                for (int i = 0; i < tickets; i++){
                                    do{
                                        ...
                                        seatRow=ReadNumber(0, ROWS);
                                        // ask seat column
                                        System.out.print("Choose a column: ");
                                        seatColumn=ReadNumber(0, COLUMNS);
    ...
    public static int AvailableSeats(char seats[][]){
    ...
    public static void TicketsChange(char seats[][]){
        // Tickets can be changed when there is at least one ticket purchased and one seat available for exchange.
        int occupiedSeats = ROWS * COLUMNS - AvailableSeats(seats);
        if(AvailableSeats(seats) > 0 && occupiedSeats > 0){
            ...
            do{
                changedTickets=WhichTicketsChange(changedTickets, occupiedSeats, AvailableSeats(seats));
            }while(changedTickets > occupiedSeats|| changedTickets > AvailableSeats(seats));
    ...
    //antes de ponerme con lo nuevo terminar de optimizar lo copiado del ejercicio 6(lo de arriba) y copiarlo al ej 6!!!!!
    //todo lo de debajo es la parte nueva
    ...
    public static void assignSeatsAutomatically(){
