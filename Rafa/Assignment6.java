...
public class Assignment6 {
    ...
    public static int read(int LB, int UB, String prompt){
        int ticket;
        boolean grant;
        do {
            grant = false;
            ...
            if (LB < ticket && ticket > UB) {
                ...
                System.out.println("ERROR. Put again the value");
                grant = false;
            }
        } while (grant = false);
    ...
    public static void askchange(int availableSeats){

    } 
    public static void available(int availableSeats){
        System.out.println("\n Currently there are " + availableSeats + " available seats.");
    }
    public static int nchanges(int availableSeats){
