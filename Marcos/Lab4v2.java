                ...
                case 2:
                    if (ticketPrice <= 0) {
                        ...
                        if (autoAssignment == 1) {
                            ...
                            int remainingSeats = ticketCount, passengerIndex = 1;
                            for (int i = 0; i < seats.length; i++) {
                                if (remainingSeats > 0 && seats[i] == 'A') {
                                    seats[i] = 'O';
                                    System.out.printf("The seat %d has been assigned to passenger %d\n", i + 1, passengerIndex);
